...
[Here](https://ewfreesres.github.io/SCT-in-R/pre-submission-correctness-test.html) is a description of what these elements look like when coded in `R`.
...
*  Alternatively (or in addition), you might want to check out:
      ...
      *  https://instructor-support.datacamp.com/en/articles/2312002-submission-correctness-tests
      *  https://intercom.help/datacamp-teach/en/articles/2348740-submission-correctness-tests-deep-dive
      *  https://intercom.help/datacamp-teach/en/articles/2348777-submission-correctness-tests-best-practices

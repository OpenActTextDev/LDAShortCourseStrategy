...
*  Use whatever recording system that you like. If you do not have experience in this, one easily accessible avenue is to use Zoom's ability to record. This is how the Frees examples in Chapter one were done. 
...
Tutorial problem contributors do not need to get into the online tutorial system. Just simply provide the problem set-up (assignment and instructions) and the `R`-code solutions. However, if you would like to learn more, see the following.
...
These are fairly specialized part of the tutorial system; so, we hope to get one or two volunteers that will focus on this aspect. 

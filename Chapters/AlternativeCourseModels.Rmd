...
The proposal and plan to date is based on a developed book [Loss Data Analytics](https://openacttexts.github.io/) as well as a template for a comparable [online tutorial](https://ewfreesres.github.io/RegressModel/) on regression that has worked well so far. However, as we gain access to more creative and dedicated volunteers, we are hopeful to improve our model for short course offerings.
